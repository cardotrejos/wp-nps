...
- Free tier (50 surveys/month) - _Note: Consider paid-only launch, add free tier post-validation_

**Shopify Integration:** _Moved to Growth - reduces MVP risk from App Store approval timeline_
...
_Decision: Launch with Starter ($49) and Growth ($149) only. Add free tier after validating revenue._
