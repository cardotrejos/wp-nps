...
export const apiKeyAuth = new Elysia({ name: "api-key-auth" }).derive(async ({ request }) => {
...
export function requireApiKey(apiKeyOrg: ApiKeyContext | null): asserts apiKeyOrg is ApiKeyContext {
  if (!apiKeyOrg) {
