...
export function WhatsAppMessage({
  ...
  return (
    <div
      ...
      role="article"
      aria-label="Survey question message"
    >
      <div className="relative max-w-[85%] rounded-lg rounded-tl-none bg-white p-3 pb-5 shadow-sm">
        ...
        <div
          className="absolute -left-2 top-0 h-0 w-0 border-l-[8px] border-t-[8px] border-l-transparent border-t-white"
          aria-hidden="true"
        />
        ...
        <div
          ...
          aria-label={`Sent at ${displayTimestamp}`}
        >
